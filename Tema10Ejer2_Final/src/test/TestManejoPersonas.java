...
public class TestManejoPersonas {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Crear base de datos(Cambiando la conexion antes)
                //personaDao.crearBaseDatosNueva("pruebaMetodo");
            
            //Crear tabla
                //personaDao.crearTablaNueva();
...
//            }                        
            ...
            GestorArchivos.escribirExcepcion(sw.toString().toUpperCase());                        
