...
public class GestorBaseDatos{
    ...
    private static final String SQL_UPDATE = "UPDATE cuentas SET saldo = ? WHERE id_cc = ?";
    ...
    public ArrayList<CuentasDTO> seleccionar() throws SQLException, Excepciones {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        CuentasDTO cuenta = null;
        ArrayList<CuentasDTO> cuentas = new ArrayList<>();
